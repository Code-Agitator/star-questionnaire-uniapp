...
const name = "uniapp-vite-template";
const version = "0.0.1";
...
const scripts = {
  ...
  "build:app-android:prod": "npm run build:app-android",
  ...
  "build:app-ios:prod": "npm run build:app-ios",
  ...
  "build:app:prod": "npm run build:app",
  ...
  "build:mp-alipay:prod": "npm run build:mp-alipay",
  ...
  "build:mp-baidu:prod": "npm run build:mp-baidu",
  ...
  "build:mp-jd:prod": "npm run build:mp-jd",
  ...
  "build:mp-kuaishou:prod": "npm run build:mp-kuaishou",
  ...
  "build:mp-lark:prod": "npm run build:mp-lark",
  ...
  "build:mp-qq:prod": "npm run build:mp-qq",
  ...
  "build:mp-toutiao:prod": "npm run build:mp-toutiao",
  ...
  "build:mp-weixin:prod": "npm run build:mp-weixin",
  ...
  "build:quickapp-webview-huawei:prod": "npm run build:quickapp-webview-huawei",
  ...
  "build:quickapp-webview-union:prod": "npm run build:quickapp-webview-union",
  ...
  "build:quickapp-webview:prod": "npm run build:quickapp-webview",
  ...
  "dev:app-android:dev": "npm run dev:app-android",
  ...
  "dev:app-ios:dev": "npm run dev:app-ios",
  ...
  "dev:mp-alipay:dev": "npm run dev:mp-alipay",
  ...
  "dev:mp-baidu:dev": "npm run dev:mp-baidu",
  ...
  "dev:mp-jd:dev": "npm run dev:mp-jd",
  ...
  "dev:mp-kuaishou:dev": "npm run dev:mp-kuaishou",
  ...
  "dev:mp-lark:dev": "npm run dev:mp-lark",
  ...
  "dev:mp-qq:dev": "npm run dev:mp-qq",
  ...
  "dev:mp-toutiao:dev": "npm run dev:mp-toutiao",
  ...
  "dev:mp-weixin:dev": "npm run dev:mp-weixin",
  ...
  "dev:quickapp-webview-huawei:dev": "npm run dev:quickapp-webview-huawei",
  ...
  "dev:quickapp-webview-union:dev": "npm run dev:quickapp-webview-union",
  ...
  "dev:quickapp-webview:dev": "npm run dev:quickapp-webview",
  ...
  "lint:style": 'stylelint --cache "**/*.{vue,scss,css}" --fix',
...
const dependencies = {
  ...
  "@dcloudio/uni-mp-jd": "3.0.0-alpha-4000120240201002",
  ...
  "@dcloudio/uni-mp-xhs": "3.0.0-alpha-4000120240201002",
...
const PascalCaseViteMode = common_vendor.pascalCase(ViteMode);
const DefaultBaseUrl = "http://127.0.0.1:8887";
const DefaultHeaders = {
  "Accept": "application/json",
  "Content-Type": "application/json; charset=utf-8",
  "X-Version": `${pkg.name}/${pkg.version}`
};
const TokenKey = `token${PascalCaseViteMode}`;
const DefaultToken = "";
